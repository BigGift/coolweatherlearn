...
import com.nerdlauncher.android.bignerdranch.coolweather.gson.Forecast;
import com.nerdlauncher.android.bignerdranch.coolweather.gson.Weather;
import com.nerdlauncher.android.bignerdranch.coolweather.service.AutoUpdateService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            //    SharedPreferences preferences1=getSharedPreferences("data",MODE_PRIVATE);
                String selectWeatherId=preferences.getString("selectWeatherID",null);
                requestWeather(selectWeatherId);
            }
        });
        //滑动菜单按钮
